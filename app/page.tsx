...
const proofBlocks = [
  {
    ...
    link: "/assets/LEGR%20WINNER.png",
    linkLabel: "View award slide",
  },
  {
    ...
    context:
      "Feedback from Myron Paes, Head Product Manager for Creator Copilot by Tapyoca, recognizing initiative on the sponsored capstone product.",
  },
  {
            ...
            <div className="min-w-0 max-w-3xl">
              ...
              <Reveal delay={180}>
                <p className="mt-6 max-w-2xl text-lg leading-8 text-[#394a40] sm:text-xl sm:leading-9">
                  ...
                  HackPrinceton-winning AI finance platform, a sponsored
                  capstone product, and infrastructure-heavy full-stack work.
                </p>
              </Reveal>
              <Reveal delay={250}>
          ...
          >
            ...
            <Reveal delay={100}>
              <p className="max-w-3xl text-lg leading-8 text-[#33433a] sm:text-xl sm:leading-9">
                ...
                flows, real data, reliable integrations, and fewer repeated
                tasks. My strongest work sits where product execution meets AI
                workflows and backend systems.
              </p>
            </Reveal>
            <Reveal delay={180}>
              <figure className="max-w-xs overflow-hidden rounded-[8px] border border-[#d7ddcf] bg-white/72 p-3 shadow-[0_10px_24px_rgba(30,43,34,0.05)]">
                ...
                <figcaption className="px-1 pt-4">
                  ...
                  <p className="mt-1 text-sm leading-6 text-[#506052]">
                    Full-stack engineer building useful products and practical
                    AI.
                  </p>
                </figcaption>
              </figure>
            ...
            <div className="grid gap-4 md:grid-cols-2">
              {proofBlocks.map((block, index) => (
                <Reveal key={block.source} delay={index * 100}>
                  <figure
                    className={`flex h-full flex-col rounded-[8px] border p-6 shadow-[0_10px_24px_rgba(30,43,34,0.04)] ${
                      index === 0
                    ...
                    {block.link ? (
                      <div className="mt-auto flex justify-center pt-5">
                        <a
                          ...
                          target="_blank"
                          rel="noreferrer"
                          className="flex min-h-10 w-fit items-center justify-center rounded-full bg-[#17231c] px-5 text-sm font-bold !text-white transition hover:-translate-y-0.5 hover:bg-[#25372d]"
                        >
                          {block.linkLabel}
                        </a>
                      </div>
              ...
              <div>
                ...
                <Reveal delay={220}>
                  <p className="mt-4 max-w-2xl text-base leading-8 text-[#dce5d7]">
                    ...
                    automation, and software engineering opportunities where I
                    can contribute to real products.
                  </p>
                </Reveal>
              </div>
              <Reveal delay={260}>
